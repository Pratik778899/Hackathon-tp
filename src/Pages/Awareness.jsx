    ...
    <>
      <div className="container mx-auto p-4 mt-6 flex flex-col md:flex-row justify-between items-center">
        <div className="w-full md:w-3/5 mb-8 md:mb-0">
          <div className="border-blue-600 border-2 font-bold p-2 rounded mt-0 md:ml-20 w-3/12">
            <h1 className="text-lg text-blue-600 ml-5">Welcome to Educate</h1>
          </div>
          <div className="ml-4 md:ml-16 mt-4">
            <h1 className="text-3xl md:text-5xl font-bold">Education/Parent Awareness</h1>
          </div>
      ...
      <div className="ml-4 md:ml-20">
        <div className="border-2 border-black rounded-2xl p-2 md:mr-20 my-5">
          <h1 className="text-3xl font-bold">Navigating the Academic Landscape</h1>
        ...
        <div className="border-2 border-black rounded-2xl p-2 md:mr-20 my-5">
          <h1 className="text-3xl font-bold">Supporting Your Child's Learning</h1>
        ...
        <div className="border-2 border-black rounded-2xl p-2 md:mr-20 my-5">
          <h1 className="text-3xl font-bold">Resources for Parental Involvement</h1>
        ...
        <div className="border-2 border-black rounded-2xl p-2 md:mr-20 my-5">
          <h1 className="text-3xl font-bold">FAQs and Support</h1>
